...
def test_merge_mediainfo(test_ora_log, test_sf_log, test_exif_log, test_mediainfo_mult_f, test_key_list_file):
    merged_sf_log = merge_sf_logs(load_json(test_ora_log), test_sf_log,
                                  "filename")

    merged_logs_with_exif = merge_exif_to_base_log(test_exif_log, merged_sf_log, test_key_list_file,"SourceFile")

    merged_mediainfo_with_sf = merge_mediainfo(merged_logs_with_exif, test_mediainfo_mult_f, "@ref")
    for f in merged_sf_log:
        assert "exif" in merged_mediainfo_with_sf[f].keys()
